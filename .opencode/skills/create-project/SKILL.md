...
```json
{
  "skills": {
    "skill-creator": "../skills_and_mcps/skills/anthropic/skill-creator",
    "api-research": "../skills_and_mcps/skills/daydreams/api-research",
    "lucid-agent-sdk": "../skills_and_mcps/skills/daydreams/lucid-agent-sdk",
    "lucid-client-api": "../skills_and_mcps/skills/daydreams/lucid-client-api",
    "railway-deploy": "../skills_and_mcps/skills/daydreams/railway-deploy"
  }
}
```
